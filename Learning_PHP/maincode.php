...
function is_data_valid()
{
  ...
  $ret_arr['valid']=true;
    ...
    {
      $ret_arr['errMsg']['english'] = 'Marks should be less then 100 and not equal to zero';
      $ret_arr['valid'] = false;
    }
    else
    {
    ...
    {
      $ret_arr['errMsg']['hindi'] = 'Marks should be less then 100 and not equal to zero';
      $ret_arr['valid'] = false;
    }
    else
    {
    ...
    {
      $ret_arr['errMsg']['math'] = 'Marks should be less then 100 and not equal to zero';
      $ret_arr['valid'] = false;
    }
    else
    {
    ...
    {
      $ret_arr['errMsg']['social'] = 'Marks should be less then 100 and not equal to zero';
      $ret_arr['valid'] = false;
    }
    else
    {
    ...
    {
      $ret_arr['errMsg']['computer'] = 'Marks should be less then 100 and not equal to zero';
      $ret_arr['valid'] = false;
    }
    else
    {
